...
<div>
      <div id="auto-slider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="item">
            <img src="assets/img/cirebon/2.jpg" alt="...">
        ...
        <!-- Controls -->
        <a class="left carousel-control" href="#auto-slider" role="button" data-slide="prev">
          <span class="glyphicon glyphicon-chevron-left"></span>
        </a>
        <a class="right carousel-control" href="#auto-slider" role="button" data-slide="next">
